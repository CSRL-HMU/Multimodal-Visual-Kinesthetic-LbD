...
if os.name == 'nt': # the OS is Windows
    data = scipy.io.loadmat(str(folderPath) +'\\Logging_kinesthetic.mat')
...
scipy.io.savemat("training_demo_kinesthetic.mat", mdic)
...
if os.name == 'nt': # the OS is Windows
    data = scipy.io.loadmat(str(folderPath) +'\\training_demo_kinesthetic.mat')
else:   # the OS is Linux
    data = scipy.io.loadmat(str(folderPath) +'/training_demo_kinesthetic.mat')
...
mdic = {"W": dmpTask.get_weights(), "T": dmpTask.T}
scipy.io.savemat("dmp_model_kinesthetic.mat", mdic)
